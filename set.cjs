...
const config = {
  SESSION_ID: process.env.SESSION_ID || "Gifted~ajZAUayK#sx08sM8ferVwQR8HrxAH-01P0rxb3yH03zdnkRu8jAI",
  ...
  OWNER_NAME: process.env.OWNER_NAME || "MSAZZ7ʜ",
  AUTO_BLOCK: process.env.AUTO_BLOCK || "212,99,90",
  OWNER_NUMBER: process.env.OWNER_NUMBER || "255693816272",
